...
/**
 * Manages "Authentication" to Needle's backend service.  The SyncAdapter framework
 ...
 */
public class NeedleAuthenticator extends AbstractAccountAuthenticator {

    public NeedleAuthenticator(Context context) {
        super(context);
    }
