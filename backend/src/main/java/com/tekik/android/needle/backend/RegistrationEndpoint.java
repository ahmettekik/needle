...
package com.tekik.android.needle.backend;
 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.needle.android.tekik.com", ownerName = "backend.needle.android.tekik.com", packagePath = ""))
